  ...
  return (
    <div className="min-h-screen">
      ...
      <article className="py-16 sm:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <p>
            Sometimes it's not easy to be sure that it's time for a loved one to begin receiving senior home care. Raising the subject may not be something you've been looking forward to; you want to be certain they need home care before talking with them about it. Bringing in a home care provider is a sensitive topic for many seniors, and getting the timing right before having that conversation matters. To help you decide if now is the time to bring a caregiver aboard, consider these seven signs:
          </p>
